function [FinalIm,ConInc,FinalCompLevel,err1,datestamp] = IncompleteLetterFineFun(ImWidth,ImBorder,PropComp,CheckSize,WhichLetter);
% LetterIm = IncompleteLetterFineFun(ImWidth,ImBorder,PropComp,CheckSize,WhichLetter);
%
...
% v3, June 2023
%
% e.g. [FinalIm,ConInc,FinalCompLevel,err1,datestamp] = IncompleteLetterFineFun(275,0,0.15,11,'P'); imshow(FinalIm);
%
